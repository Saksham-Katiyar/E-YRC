defmodule FW_DEMO do
  ...
  defp line_follower() do
    path = ["move", "right", "move", "move"]
    follow_line(path)
  end

  defp follow_line(path) do
    if length(path) > 0 do
      cond do
  ...
  """
  defp test_motion(sleep, motion_list) do
