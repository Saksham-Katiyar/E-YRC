defmodule FW_DEMO do
  ...
  def go_strt() do
    ...
    test_965 = Enum.map(ir_values, fn x -> if x > 965 do 1 else 0 end end)
    ...
    cond do
      ...
      n <= 3 ->
        ...
        pwm_testing(trunc(@forward_pwm + turning_pwm), trunc(@forward_pwm - turning_pwm))
