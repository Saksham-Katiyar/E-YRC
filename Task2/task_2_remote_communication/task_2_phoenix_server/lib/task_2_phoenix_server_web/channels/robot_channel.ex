defmodule Task2PhoenixServerWeb.RobotChannel do
  ...
  def handle_in("new_msg", message, socket) do
    ...
    bottom_value = case message["y"] do
      "a" -> 0
      "b" -> 150
      "c" -> 300
      "d" -> 450
    ...
    msg_update = %{"left" => left_value, "bottom" => bottom_value, "face" => face_value}

    Phoenix.PubSub.subscribe(Task2PhoenixServerWeb.PubSub, "robot:update")
    Phoenix.PubSub.broadcast(Task2PhoenixServerWeb.PubSub, "robot:update", msg_update)
