defmodule Task2PhoenixServerWeb.ArenaLive do
  ...
  def handle_info(data ,socket) do
    ...
    socket = case data["face"] do
      "north" -> assign(socket, :img, "robot_facing_north.png")
      "south" -> assign(socket, :img, "robot_facing_south.png")
      "east" -> assign(socket, :img, "robot_facing_east.png")
      "west" -> assign(socket, :img, "robot_facing_west.png")
    end
